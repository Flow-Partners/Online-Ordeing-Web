...
// projects/client/src/app/core/services/api.service.ts
var ApiService = class _ApiService {
  ...
  get(endpoint, options) {
    return this.http.get(`${this.apiUrl}${endpoint}`, options).pipe(timeout(this.apiTimeout), map((response) => this.handleResponse(response)), catchError((error) => this.handleError(error)));
  }
  /**
   * POST request
   */
  post(endpoint, body, options) {
    return this.http.post(`${this.apiUrl}${endpoint}`, body, options).pipe(timeout(this.apiTimeout), map((response) => this.handleResponse(response)), catchError((error) => this.handleError(error)));
  }
  /**
   * PUT request
   */
  put(endpoint, body, options) {
    return this.http.put(`${this.apiUrl}${endpoint}`, body, options).pipe(timeout(this.apiTimeout), map((response) => this.handleResponse(response)), catchError((error) => this.handleError(error)));
  }
  /**
   * PATCH request
   */
  patch(endpoint, body, options) {
    return this.http.patch(`${this.apiUrl}${endpoint}`, body, options).pipe(timeout(this.apiTimeout), map((response) => this.handleResponse(response)), catchError((error) => this.handleError(error)));
  }
  /**
   * DELETE request
   */
  delete(endpoint, options) {
    return this.http.delete(`${this.apiUrl}${endpoint}`, options).pipe(timeout(this.apiTimeout), map((response) => this.handleResponse(response)), catchError((error) => this.handleError(error)));
  }
  /**
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-7V4CR2SO.js.map
